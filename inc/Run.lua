...
▄█████████▀           ██               ██             ██                    ██▄████████▀ │kgt ﹏ @KGTBR
│
تم تطوير وبرمجة السورس من قبل Mahmoud .
│@MahmoudM2
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
...
elseif msg.sender_user_id_ == 1123559936 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 1459193475 then 
msg.TheRank =  '  مطور السورس '
msg.Rank = 1

elseif msg.sender_user_id_ == 1312558822 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/MahmoudM2/Max/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/MahmoudM2/Max/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/MahmoudM2/Max/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/MahmoudM2/Max/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/MahmoudM2/Max/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/MahmoudM2/Max/main/plugins/games.lua','./plugins/games.lua')
