...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/MahmoudM2/Max/main/GetVersion.txt' ) or 0
...
return '• اصدار سورس فاست : *v'..version..'* \n'
end
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/otlop12"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : فاست](https://t.me/otlop12)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "حودا" or Text== "محمود" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس فاست](https://t.me/MahmoudM2)")
elseif Text== "توب" or Text== "االتوب then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس 𖠲](https://t.me/xxmeanxx)")
elseif Text== "فاست" or Text== "سورس فاست" then return  sendMsg(msg.chat_id_,msg.id_,"[احسن سورس مصري ↯](https://t.me/otlop12)")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "سلام" or Text== "السلام عليكم" or Text== "سلام عليكم" or Text=="السلام عليكم" or Text=="السلامن عليكم" then 
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/SouRce_bott) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/SouRce_bott)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/SouRce_bott)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/SouRce_bott)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/SouRce_bott)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/SouRce_bott) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/SouRce_bott)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SouRce_bott)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SouRce_bott)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SouRce_bott)")
